        ...
        <ul className='feature-list'>
          <li className='feature-list-item'>
            ...
            <div className='feature-header-and-description'>
              ...
              <p>Know where you're going, see where you've been.
                Choose from one of our routes or be bold and create your
                own.</p>
            </div>
          </li>
          <li className='feature-list-item'>
          ...
          <li className='feature-list-item'>
            ...
            <div className='feature-header-and-description'>
              ...
              <p> Get extra encouragement, cheer on your buddies or
                start a little friendly competition.</p>
            </div>
          </li>
        </ul>
      </div>
